...
> chat_id - id чата <br>
> 300 - задержка повторных отправок сообщений при критических ошибках (можно редактировать в самом боте) <br>

>> где взять TOKEN и chat_id можете в статье ![Настройка телеграм бота](https://nodera.org/panic_bot#gugm)
